...
const Portfolio = () => {
  const [items, setItems] = useState (Menu); //-- recuperamos los items del menu
  ...
  return (
    ...
    <section className="work container section" id="portfolio">
      ...
      <div className="work__filters">
        ...
        <span className="work__item"onClick={()=> filterItem("Otros")}>Otros</span>
        {/* <span className="work__item"onClick={()=> filterItem("Branding")}>Branding</span> */}
      </div>

      <div className="work__container grid">  {/* los recuperamos */}
        {items.map((elem) =>{
